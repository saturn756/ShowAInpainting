...
The [interactive English preview](https://saturn756.github.io/ShowAInpainting/diagrams/architecture.en.html) and [interactive Chinese preview](https://saturn756.github.io/ShowAInpainting/diagrams/architecture.zh-CN.html) use the same topology and data paths. Static PNG exports remain available as [English](diagrams/architecture.en.png) and [简体中文](diagrams/architecture.zh-CN.png); the HTML viewers are served by the GitHub Pages workflow.
