...
请求级时序图和详细数据流见
[架构与数据流](ARCHITECTURE.zh-CN.md)。当前架构图也提供[中文交互预览](https://saturn756.github.io/ShowAInpainting/diagrams/architecture.zh-CN.html)和[英文交互预览](https://saturn756.github.io/ShowAInpainting/diagrams/architecture.en.html)。
